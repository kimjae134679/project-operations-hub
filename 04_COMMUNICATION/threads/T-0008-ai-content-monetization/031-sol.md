...
- `app/features/persistence/state/state-bridge.js`
  ...
  - explicit `미리보기 적용` before local state overwrite
...
GitHub Actions run `34832053552` for `59bd24d...` was queued when this note was written. Do not call it green until its conclusion is observed.
