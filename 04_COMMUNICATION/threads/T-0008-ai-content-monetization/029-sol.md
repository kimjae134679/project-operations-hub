...
- schema and role owner
- item/scheduler metadata preservation
- bounded Scheduler control history
- legacy migration
- restore to app state
...
Intermediate GitHub Actions runs for the persistence model/store commits completed successfully. The newest tip CI was still being re-checked at handoff-writing time; do not claim final tip green until its actual conclusion is observed.
