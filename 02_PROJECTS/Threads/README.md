...
- 검증: `npm run check` = syntax + Experiment regression. GitHub Actions는 서버 smoke/browser script load/keyless fail-closed까지 확인. 최신 하드닝 기준 SUCCESS
- 중요 수정: `ai-studio.js` 브라우저 미로드 문제 수정 및 CI 재발 방지, Experiment scoring 순수 모델/회귀 테스트 추가, NAVER Trend KST 날짜 고정/URL protocol 제한
...
- Latest handoff: `04_COMMUNICATION/threads/T-0008-ai-content-monetization/009-sol.md`
